        ...
        <div class="md:p-14 sm:p-6">
            <div class="overflow-x-auto overflow-y-hidden">
                <form action={{ route('vaccine.update', $vaccine) }} method="POST">
                    ...
                    <x-helpers.form-field value="{{old('title')??$vaccine->title}}" type="text" field="title" text="Título" placeholder="Ej: Vacuna Rabia" />
                    <x-helpers.form-field value="{{old('description')??$vaccine->description}}" type="text" field="description" text="Descripción" placeholder="Ej: Vacuna que protege a los animales contra la rabia" />
