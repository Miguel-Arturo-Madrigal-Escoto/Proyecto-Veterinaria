            ...
            <div class="flex-1 px-3 space-y-1 bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                ...
                <li>
                    ...
                    <ul id="dropdown-crud" class="space-y-2 py-2 ">
                        ...
                        <li>
                            <a href="" class="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11 dark:text-gray-200 dark:hover:bg-gray-700 gray-100 dark:bg-gray-700 ">Users</a>
                        </li>
                    </ul>
                </li>
                <li>
