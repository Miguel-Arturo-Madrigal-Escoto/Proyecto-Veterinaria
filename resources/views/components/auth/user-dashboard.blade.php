<div>
    ...
    <div class="flex flex-row justify-evenly items-center my-4 p-10 flex-wrap">
        <x-helpers.card-with-image title="Mis Mascotas" image="{{asset('img/pet-card.jpg')}}" alt="imagen de mis mascotas">
            <p class="text-justify text-base my-2">
                A continuación se muestra la cantidad de mascotas que estan registradas en
                esta cuenta con su correspondiente especie:
            </p>
        ...
        <x-helpers.card-with-image title="Mis Citas" image="{{asset('img/pet-appointment.jpg')}}" alt="imagen de mis mascotas">
            <p class="text-justify text-base my-2">
                A continuación se muestran la cantidad de citas que estan registradas en
                esta cuenta en base con su estatus:
            </p>
            <div class="flex flex-col">
