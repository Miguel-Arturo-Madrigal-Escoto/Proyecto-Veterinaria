    ...
    <div class="flex flex-col justify-center items-center">
        ...
        <div class="w-full max-w-2xl mx-auto bg-white shadow-lg rounded-lg border border-gray-20 dark:bg-slate-900">
            <header class="px-5 py-4 border-b border-gray-100 dark:border-none">
                <h1 class="font-semibold text-gray-800 text-center dark:text-white">Formulario de registro</h1>
            </header>
            <div class="p-3">
                <div class="overflow-x-auto">
                    <form action="/cliente" method="POST" class="">
                        ...
                        <x-helpers.form-field value="{{old('password_confirm')}}" type="password" field="password" text="Confirma la contraseña" placeholder="********" />
