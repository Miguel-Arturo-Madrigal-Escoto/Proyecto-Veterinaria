            ...
            <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
                <div class="mx-auto max-w-screen-sm text-center flex flex-col justify-center items-center">
                    <figure class="max-w-lg">
                        <img class="h-auto max-w-full rounded-lg my-6" src={{ asset('img/404-not-found.png') }} alt="imagen del error 404" loading="lazy">
                    ...
                    <p class="mb-4 text-3xl tracking-tight font-bold text-gray-900 md:text-4xl dark:text-white">404 Not Found</p>
